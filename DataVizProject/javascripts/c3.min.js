! function(a) {
    ...
    function d(a, b) {
                ...
                function j(a, c) {
                    function d(a, b) {
                        ...
                        for (var h = 1; h < b.length; h++)
                            if (" " === b.charAt(h) && (f = h), e = b.substr(0, h + 1), g = O.w * e.length, g > c) return d(a.concat(b.substr(0, f ? f : h)), b.slice(f ? f + 1 : h));
                        return a.concat(b)
                    }
                    var e, f, g, i = h(a),
                        j = [];
        ...
        return b = b || {}, k = b.withOuterTick ? 6 : 0, j.scale = function(a) {
            ...
            return arguments.length ? (p = a in {
                top: 1,
                right: 1,
                bottom: 1,
                left: 1
    ...
    g.generate = function(a) {
        ...
        var c, d, e, f, g, h, j, k, l, m, n, o, p, q, r, s, u, v, w, x, y, z, A, B, C, D, E, F, G, H = this,
            I = H.main,
            J = H.d3,
            K = H.config,
        ...
        var d, e, f, g, h, i, k, l, m, n, o, p = this,
            r = p.config,
        ...
        var f, g, h, i, j, k, l, o, p, q, r, s, t = this,
            u = t.config,
            v = -1,
            w = "M",
            x = [];
        if (n(d))
            for (f = 0; f < d.length; f++) x[f] = {}, x[f].start = m(d[f].start) ? a[0].x : t.isTimeSeries() ? t.parseDate(d[f].start) : d[f].start, x[f].end = m(d[f].end) ? a[a.length - 1].x : t.isTimeSeries() ? t.parseDate(d[f].end) : d[f].end;
        for (r = u.axis_rotated ? function(a) {
            ...
            if (m(x) || !e(a[f].x, x)) w += " " + r(a[f]) + " " + s(a[f]);
                ...
                for (i = t.getScale(a[f - 1].x, a[f].x, t.isTimeSeries()), j = t.getScale(a[f - 1].value, a[f].value), k = b(a[f].x) - b(a[f - 1].x), l = c(a[f].value) - c(a[f - 1].value), o = Math.sqrt(Math.pow(k, 2) + Math.pow(l, 2)), p = 2 / o, q = 2 * p, g = p; 1 >= g; g += q) w += h(a[f - 1], a[f], g, p);
            v = a[f].x
        }
        return w
        ...
        var c, d = this.d3.select("body").classed("c3", !0),
    ...
    f.clearLegendItemTextBoxCache = function() {
        ...
        var f, g, j, k, l, m, o, p, q, r, s, u, v, w = this,
            x = w.config,
            y = 4,
            z = 10,
            A = 0,
        ...
        k.hasArcType() || l.data_selection_enabled && (!l.zoom_enabled || k.zoom.altDomain) && l.data_selection_multiple && (b = k.dragStart[0], c = k.dragStart[1], d = a[0], e = a[1], f = Math.min(b, d), g = Math.max(b, d), h = l.data_selection_grouped ? k.margin.top : Math.min(c, e), j = l.data_selection_grouped ? k.height : Math.max(c, e), m.select("." + i.dragarea).attr("x", f).attr("y", h).attr("width", g - f).attr("height", j - h), m.selectAll("." + i.shapes).selectAll("." + i.shape).filter(function(a) {
            ...
            var c, d, e, l, m, o, p = n.select(this),
                ...
                s = !1;
            if (p.classed(i.circle)) c = 1 * p.attr("cx"), d = 1 * p.attr("cy"), m = k.togglePoint, s = c > f && g > c && d > h && j > d;
            else {
    ...
    e.focus = function(a) {
        ...
        var b, c, d, e, f, g, h, i, k = this.internal,
            l = [],
            m = k.getMaxDataCount(),
            o = 0,
            p = 0;
    ...
    }, e.tooltip = function() {}, e.tooltip.show = function(a) {
